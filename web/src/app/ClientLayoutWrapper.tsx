...
export default function ClientLayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  // Hide main header/footer if taking a test (so it looks like real exam)
  const isRealExamLayout = pathname?.includes('/ielts/listening/') || pathname?.includes('/ielts/reading/')
